...
void CustomModel::writeToFile()
{
	...
	else
	{
		...
		//std::vector<EQEmu::EQG::Geometry::Vertex> vertices = model->GetVertices();
		...
		{
			//entry->polys.emplace_back(ModelEntry::Poly{ poly.verts[0], poly.verts[1], poly.verts[2], (poly.flags & 0x10) == 0 });
